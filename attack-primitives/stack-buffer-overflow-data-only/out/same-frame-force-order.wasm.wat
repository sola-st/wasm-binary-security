(module
  ...
  (data (;0;) (i32.const 1024) "&buf_overflow:   %p\0a buf_overflow:   %s\0a\00&buf_other_data: %p\0a buf_other_data: %s\0a")
  (data (;1;) (i32.const 1114) "BBBBBBB\00\00\00\c8\08\00\00-+   0X0x\00(null)")
  (data (;2;) (i32.const 1152) "\11\00\0a\00\11\11\11\00\00\00\00\05\00\00\00\00\00\00\09\00\00\00\00\0b")
  (data (;3;) (i32.const 1184) "\11\00\0f\0a\11\11\11\03\0a\07\00\01\13\09\0b\0b\00\00\09\06\0b\00\00\0b\00\06\11\00\00\00\11\11\11")
  (data (;4;) (i32.const 1233) "\0b")
  (data (;5;) (i32.const 1242) "\11\00\0a\0a\11\11\11\00\0a\00\00\02\00\09\0b\00\00\00\09\00\0b\00\00\0b")
  (data (;6;) (i32.const 1291) "\0c")
  (data (;7;) (i32.const 1303) "\0c\00\00\00\00\0c\00\00\00\00\09\0c\00\00\00\00\00\0c\00\00\0c")
  (data (;8;) (i32.const 1349) "\0e")
  (data (;9;) (i32.const 1361) "\0d\00\00\00\04\0d\00\00\00\00\09\0e\00\00\00\00\00\0e\00\00\0e")
  (data (;10;) (i32.const 1407) "\10")
  (data (;11;) (i32.const 1419) "\0f\00\00\00\00\0f\00\00\00\00\09\10\00\00\00\00\00\10\00\00\10\00\00\12\00\00\00\12\12\12")
  (data (;12;) (i32.const 1474) "\12\00\00\00\12\12\12\00\00\00\00\00\00\09")
  (data (;13;) (i32.const 1523) "\0b")
  (data (;14;) (i32.const 1535) "\0a\00\00\00\00\0a\00\00\00\00\09\0b\00\00\00\00\00\0b\00\00\0b")
  (data (;15;) (i32.const 1581) "\0c")
  (data (;16;) (i32.const 1593) "\0c\00\00\00\00\0c\00\00\00\00\09\0c\00\00\00\00\00\0c\00\00\0c\00\000123456789ABCDEFgetAfter(region) <= sbrk(0)\00/mnt/Data/Downloads/2019-09-26-wasm-poc-exploits/emcc-upstream/emsdk/upstream/emscripten/system/lib/emmalloc.cpp\00emmalloc_malloc\00size > 0\00getBigEnoughFreeListIndex\00getFreeListIndex\00MIN_FREELIST_INDEX <= index && index < MAX_FREELIST_INDEX\00payloadSize >= size\00possiblySplitRemainder\00extra >= MIN_REGION_SIZE\00totalSplitSize >= MIN_REGION_SIZE\00ptr == getAfter(lastRegion)\00extendLastRegion\00addToFreeList\00mergeIntoExistingFreeRegion\00region == lastRegion\00newAllocation\00(char*)extraPtr == (char*)ptr + sbrkSize\00allocateRegion\00!lastRegion\00!firstRegion\00firstRegion\00getPayload\00region->getUsed()")
  (data (;17;) (i32.const 2248) "\05")
  (data (;18;) (i32.const 2260) "\01")
  (data (;19;) (i32.const 2284) "\02\00\00\00\03\00\00\00X\0a\00\00\00\04")
  (data (;20;) (i32.const 2308) "\01")
  (data (;21;) (i32.const 2323) "\0a\ff\ff\ff\ff")
  (data (;22;) (i32.const 2580) "\84\0e"))
