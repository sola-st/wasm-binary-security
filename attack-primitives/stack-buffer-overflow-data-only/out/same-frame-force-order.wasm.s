...
# %bb.0:                                # %entry
	...
	local.tee	3
	i32.const	0
	i64.load	.L__const.main.two_bufs+8:p2align=0
	i64.store	0
	local.get	2
	i32.const	0
	i64.load	.L__const.main.two_bufs:p2align=0
	i64.store	0
	local.get	2
	local.get	3
	call	print_bufs
...
.L.str.1:
	...
	.type	.L__const.main.two_bufs,@object # @__const.main.two_bufs
	.section	.rodata..L__const.main.two_bufs,"",@
.L__const.main.two_bufs:
	.skip	8
	.asciz	"BBBBBBB"
	.size	.L__const.main.two_bufs, 16
