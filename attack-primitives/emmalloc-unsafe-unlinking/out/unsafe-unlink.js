...
var wasmBinaryFile = 'unsafe-unlink.wasm';
...
var ASM_CONSTS = [function() {window.main_bytes = function(array) { ccall("main_bytes", null, ["array", "number"], [array, array.length]); };}];
...
var real__main_bytes = asm["main_bytes"];
asm["main_bytes"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__main_bytes.apply(null, arguments);
};
...
var _main_bytes = Module["_main_bytes"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["main_bytes"].apply(null, arguments)
};
